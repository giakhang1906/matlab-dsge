...
residual = zeros(19, 1);
    residual(1) = (0) - ((1-params(1)*(1-params(4)))*y(5));
    residual(2) = (y(1)) - (T(12)*(T(3)*(y(3)+y(6))-params(4)*y(2)));
    residual(3) = (y(5)) - (y(6));
    residual(4) = (y(7)-y(1)) - ((-params(2))*(y(14)-y(13)));
    residual(5) = (y(8)-y(1)) - ((-params(2))*(y(15)-y(13)));
    residual(6) = (y(13)) - (0.5*y(14)+0.5*y(15));
    residual(7) = (y(3)) - (params(4)*y(2)+(1-params(4))*y(3));
    ...
    residual(19) = (y(18)) - ((T(10)*(y(1)+y(13))+(T(8)-(1-params(7))*T(3)*T(5))*params(10)*y(16)+(T(9)-T(3)*T(7))*params(11)*y(17)-T(5)*params(7)*T(3)*(y(5)+y(11)))/T(11));
