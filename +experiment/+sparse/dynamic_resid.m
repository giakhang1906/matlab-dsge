...
residual = NaN(19, 1);
    residual(1) = (y(39)-y(20)) - ((1-params(1)*(1-params(4)))*y(43));
    ...
    residual(10) = (y(35)*(T(9)-(1-params(7))*T(3)*T(7))) - ((y(33)+y(28))*T(9)-(y(24)+y(30))*(1-params(7))*T(3)*T(7));
    ...
    residual(19) = (y(37)) - (((y(20)+y(32))*T(11)+params(10)*y(35)*(T(9)-(1-params(7))*T(3)*T(7))+params(11)*y(36)*(T(10)-T(3)*T(8))-(y(24)+y(30))*params(7)*T(3)*T(7))/T(12));
end
