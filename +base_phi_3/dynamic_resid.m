...
if T_flag
    T = base_phi_3.dynamic_resid_tt(T, y, x, params, steady_state, it_);
end
residual = zeros(19, 1);
residual(1) = params(12)*(y(22)-y(3))+y(25)-y(15)-params(1)*T(3)*y(24);
    ...
    residual(10) = (y(18)*(T(9)-(1-params(7))*T(3)*T(7))) - ((y(16)+y(11))*T(9)-(y(13)+y(7))*(1-params(7))*T(3)*T(7));
    ...
    residual(19) = (y(20)) - (((y(3)+y(15))*T(11)+params(10)*(y(18)*(T(9)-(1-params(7))*T(3)*T(7))+y(19)*(T(10)-T(3)*T(8)))-(y(13)+y(7))*params(7)*T(3)*T(7))/T(12));
