...
rhs(10) = T(3)*(T(4)*(y(33)+y(28))-y(38)*params(6)*(y(24)-y(11)));
lhs(11) = y(36);
rhs(11) = T(5)*(T(4)*(y(34)+y(29))/(params(7)*params(12))-y(25)-y(12));
lhs(12) = y(33)+y(28);
rhs(12) = y(24)+y(11);
lhs(13) = y(34)+y(29);
rhs(13) = y(25)+y(12);
lhs(14) = y(11);
rhs(14) = T(6)*(y(24)-y(38)-y(33));
lhs(15) = y(12);
rhs(15) = T(7)*(y(25)-y(34));
lhs(16) = y(11);
rhs(16) = y(3)+(steady_state(4));
lhs(17) = y(12);
rhs(17) = y(3)+0.5*(steady_state(4));
lhs(18) = y(38);
rhs(18) = params(9)*y(19)+x(1);
lhs(19) = y(37)*T(14);
rhs(19) = T(11)*T(15)+params(11)*(y(35)*T(12)+y(36)*T(13))-T(11)*T(1)*params(8)*(y(24)+y(30));
end
