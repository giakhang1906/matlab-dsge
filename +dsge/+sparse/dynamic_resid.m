...
residual = NaN(19, 1);
    residual(1) = (1) - (T(5)*T(6));
    residual(2) = (y(21)) - (y(41)-(1-params(5))*y(22));
    residual(3) = (y(20)) - ((y(22)*(y(25)+y(23)*(y(24)-y(25)))-y(21))/((1+params(10))*y(32)));
    residual(4) = (y(25)) - (y(24));
    residual(5) = (y(26)) - (y(20)*T(8));
    residual(6) = (y(27)) - (y(20)*T(10));
    residual(7) = (y(32)) - (T(11)^(1/(1-params(3))));
    residual(8) = (y(28)) - (y(38)*T(12));
    ...
    residual(12) = (y(33)) - (T(13)*y(24)*(1-params(8))/T(14));
    residual(13) = (y(34)) - (T(13)*y(25)/T(15));
    residual(14) = (y(30)) - (T(17));
    residual(15) = (y(31)) - (T(18));
    residual(16) = (y(22)) - (T(17)/y(23));
    residual(17) = (y(22)) - (T(18)+y(22)*y(23));
