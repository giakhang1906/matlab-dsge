...
residual(2) = y(20)*(1/params(1)-1)/T(1)+params(5)*(y(21)-y(32))/T(1);
    ...
    residual(10) = (y(35)) - (T(6)*T(7));
    residual(11) = (y(36)) - (T(1)*T(10)*(y(25)+y(31)+params(3)*(y(34)+y(29))/(params(12)*params(7)*(params(3)-1))));
    residual(12) = (y(33)+y(28)) - (y(24)+y(30));
    residual(13) = (y(34)+y(29)) - (y(25)+y(31));
    residual(14) = (y(30)) - (T(4)*(y(24)-y(38)-y(33)));
    residual(15) = (y(31)) - (T(9)*(y(25)-y(34)));
    residual(16) = (y(30)) - (y(22)+y(23));
    residual(17) = (y(31)) - (y(22)+0.5*y(23));
    residual(18) = (y(38)) - (params(9)*y(19)+x(1));
    residual(19) = (T(10)*T(11)*T(12)+params(11)*(T(2)*y(35)*T(13)-T(6)+T(8)*y(36)*params(12)*T(14)-T(1)*T(10))) - (T(5)*T(1)*params(8)*(y(24)+y(30))+y(37)*(T(16)+params(11)*(T(2)*T(13)-T(6)+T(8)*params(12)*T(14)-T(1)*T(10))-T(5)*T(1)*params(8)));
end
