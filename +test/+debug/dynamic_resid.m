...
lhs(1) = y(20)-y(1);
rhs(1) = (1-params(1)*(1-params(5)))*y(24);
lhs(2) = y(1);
rhs(2) = T(6)*(T(3)*(y(3)+y(6))-params(5)*y(2));
lhs(3) = y(5);
rhs(3) = y(6);
lhs(4) = y(7)-y(1);
...
rhs(10) = T(7)*(T(8)*(y(28)+y(33))-params(6)*(y(24)-y(11)));
lhs(11) = y(36);
rhs(11) = T(9)*(T(8)*(y(29)+y(34))/(params(12)*params(7))-y(25)-y(12));
lhs(12) = y(28)+y(33);
rhs(12) = y(24)+y(11);
lhs(13) = y(29)+y(34);
rhs(13) = y(12)+y(25);
