...
residual = zeros(19, 1);
    ...
    residual(10) = (params(6)*y(19)) - (T(7)*(T(8)*(y(17)+y(13))-params(6)*(y(9)-y(2))));
    residual(11) = (y(20)) - (T(9)*(T(8)*(y(18)+y(14))/(params(12)*params(7))-y(10)-y(3)));
    residual(12) = (y(17)+y(13)) - (y(9)+y(2));
    residual(13) = (y(18)+y(14)) - (y(10)+y(3));
    residual(14) = (y(2)) - (T(4)*(y(9)-y(22)-y(17)));
    residual(15) = (y(3)) - (T(5)*(y(10)-y(18)));
    residual(16) = (y(2)) - (y(1)+y(8));
    residual(17) = (y(3)) - (y(1)+0.5*y(8));
    residual(18) = (y(22)) - (params(9)*y(4)+x(it_, 1));
    residual(19) = (y(21)) - (((y(5)+y(16))*T(14)+params(11)*(y(19)*T(12)+y(20)*T(13))-(y(9)+y(15))*params(8)*T(3)*T(10))/(T(14)+params(11)*(T(12)+T(13))-params(8)*T(3)*T(10)));
