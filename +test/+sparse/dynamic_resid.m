...
residual = NaN(19, 1);
    ...
    residual(2) = (y(20)*(1/params(1)-1)/T(1)+params(5)*(y(21)-y(32))/T(1)) - (y(22)+y(25)-y(32));
    ...
    residual(10) = (y(38)*params(6)*y(35)) - (T(2)*(T(3)*(y(33)+y(28))-y(38)*params(6)*(y(24)-y(11))));
    residual(11) = (y(36)) - (T(4)*(T(3)*(y(34)+y(29))/(params(7)*params(12))-y(25)-y(12)));
    residual(12) = (y(33)+y(28)) - (y(24)+y(11));
    residual(13) = (y(34)+y(29)) - (y(25)+y(12));
    residual(14) = (y(30)) - (T(5)*(y(24)-y(38)-y(33)));
    residual(15) = (y(31)) - (T(6)*(y(25)-y(34)));
    residual(16) = (y(11)) - (y(3)+y(23));
    residual(17) = (y(12)) - (y(3)+0.5*y(23));
    residual(18) = (y(38)) - (params(9)*y(19)+x(1));
    residual(19) = (y(37)*T(10)) - (T(7)*3*(y(25)-params(5))/(1+params(10))*params(10)*(y(20)+y(32))+params(11)*(y(35)*T(8)+y(36)*T(9))-T(7)*T(1)*params(8)*(y(24)+y(30)));
end
