...
M_.param_names(11) = {'A_NG'};
M_.param_names_tex(11) = {'A\_NG'};
M_.param_names_long(11) = {'A_NG'};
...
M_.block_structure.block(2).equation = [ 17 9 8 2 16 15 14 12 13 7 3 1];
M_.block_structure.block(2).variable = [ 12 10 9 2 4 15 14 11 6 3 5 1];
M_.block_structure.block(2).is_linear = true;
M_.block_structure.block(2).NNZDerivatives = 33;
M_.block_structure.block(2).bytecode_jacob_cols_to_sparse = [7 0 0 0 10 11 12 13 14 15 16 17 18 26 27 ];
...
M_.block_structure.block(2).g1_sparse_rowval = int32([7 1 7 2 3 6 3 6 4 5 2 4 5 1 3 6 8 1 2 3 6 7 4 5 8 1 9 9 9 ]);
M_.block_structure.block(2).g1_sparse_colval = int32([7 10 10 11 11 11 12 12 13 13 14 14 14 15 15 15 15 16 16 16 16 16 17 17 17 18 18 26 27 ]);
M_.block_structure.block(2).g1_sparse_colptr = int32([1 1 1 1 1 1 1 2 2 2 4 7 9 11 14 18 23 26 28 28 28 28 28 28 28 28 29 30 ]);
...
M_.block_structure.variable_reordered = [ 19 12 10 9 2 4 15 14 11 6 3 5 1 17 16 13 18 8 7];
M_.block_structure.equation_reordered = [ 18 17 9 8 2 16 15 14 12 13 7 3 1 11 10 6 19 5 4];
...
save([M_.dname filesep 'Output' filesep 'test_2_results.mat'], 'oo_', 'M_', 'options_');
if exist('estim_params_', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'test_2_results.mat'], 'estim_params_', '-append');
end
if exist('bayestopt_', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'test_2_results.mat'], 'bayestopt_', '-append');
end
if exist('dataset_', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'test_2_results.mat'], 'dataset_', '-append');
end
if exist('estimation_info', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'test_2_results.mat'], 'estimation_info', '-append');
end
if exist('dataset_info', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'test_2_results.mat'], 'dataset_info', '-append');
end
if exist('oo_recursive_', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'test_2_results.mat'], 'oo_recursive_', '-append');
end
if exist('options_mom_', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'test_2_results.mat'], 'options_mom_', '-append');
end
if ~isempty(lastwarn)
